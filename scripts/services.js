                ...
                var systemLeftMenu=[
                    {
                        ...
                        Appearance:[
                            ...
                            {"name":"Require authority to add to view object lists","code":"","inputType":"checkbox"},
                            {"name":"Customer login page log","code":"","inputType":"file"},
                        ...
                        DataImport:[
                            {"name":"Require periods to match period type of Entry Form","code":"","inputType":"checkbox"},
                            {"name":"Require category option combos to match category combo of data element","code":"","inputType":"checkbox"},
                            {"name":"Require Administrative units to match assignment of Entry Form","code":"","inputType":"checkbox"},
                            {"name":"Require attribute option combos to match category combo of Entry Form","code":"","inputType":"checkbox"},
                    ...
                    //,{
                    //    OAuth2Clients:[
                    //        {"name":"Name","code":"","inputType":"text"},
                    //        {"name":"Client ID","code":"","inputType":"text"},
                    //        {"name":"Client Secret","code":"","inputType":"text"},
                    //        {"name":"Password","code":"","inputType":"checkbox"},
                    //        {"name":"Refresh Token","code":"","inputType":"checkbox"},
                    //        {"name":"Authorization code","code":"","inputType":"checkbox"},
                    //        {"name":"Redirect URIs","code":"","inputType":"text"},
                    //    ]
                    //}
                ];
            ...
            var promise=$http.get(  '../../../api/organisationUnitLevels.json?fields=id,level,displayName&paging=false&order=level:asc' )
                .then(function(response){
                    angular.forEach(response.data.organisationUnitLevels,function(valueKey){
                        organisationUnitsLevel.push({"name":valueKey.displayName,"value":valueKey.id,"level":valueKey.level});
                    });
             ...
             getElementSWithOptionsForSelect:function(key,indGroup,dataGroup,orgLevel,systemSetting,configaration,styles,startModule,userRole,orgUnits,approvalLevel,optionLevl,apps){
                ...
                angular.forEach(currentObject,function(value){
                    ...
                    if(value.name=='Maximum number of analytics records'){
                        value['options'].push({"name":"Unlimited","value":0,"selected":false},{"name":"50000","value":50000,"selected":false},{"name":"100000","value":100000,"selected":false},{"name":200000,"value":200000,"selected":false});
                        ...
                        value['options'].push({"name":"Monthly","value":"Monthly","selected":false},{"name":"Quarterly","value":"Quarterly","selected":false},{"name":"Financial-July","value":"FinancialJuly","selected":false});
                        ...
                        value['options'].push({"name":"Automatic (detect based on a web server)","value":"0","selected":false}
                        ...
                        angular.forEach(value.options,function(ops){
                            if(ops.value==systemSetting.startModule){
                                ops.selected=true;
                                ops.startModule=ops.value;
                            }else{
                                ops.selected=false;
                                ops.startModule=ops.value;
                            }
